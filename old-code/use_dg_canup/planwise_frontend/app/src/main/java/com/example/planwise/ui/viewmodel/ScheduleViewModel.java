...
public class ScheduleViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<String> syncErrorMessage = new MutableLiveData<>();
    ...
    public void uploadToCloud() {
        ...
        syncErrorMessage.setValue(null);

        repository.uploadToCloud(new ScheduleRepository.SyncCallback() {
            @Override
            ...
            public void onError(String message) {
                syncErrorMessage.postValue(message);
                isSyncing.postValue(false);
            }
        });
    }
    ...
    public void downloadFromCloud() {
        ...
        repository.downloadFromCloud(new ScheduleRepository.SyncCallback() {
            @Override
            public void onSuccess() {
                isSyncing.postValue(false);
            }
